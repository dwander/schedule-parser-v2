...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        top: "inset-x-0 top-0 border-b pt-[calc(1.5rem+env(safe-area-inset-top))] pb-6 px-6 data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top",
        bottom:
          "inset-x-0 bottom-0 border-t pt-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] px-6 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
