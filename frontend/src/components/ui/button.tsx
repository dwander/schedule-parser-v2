...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground opacity-70 hover:opacity-100',
        destructive: 'bg-destructive text-destructive-foreground opacity-70 hover:opacity-100',
        outline: 'border border-input bg-background opacity-70 hover:opacity-100',
        secondary: 'bg-secondary text-secondary-foreground opacity-70 hover:opacity-100',
