...
카카오톡 메시지를 받아서 **정해진 형식**으로 변환하세요. 최대 3개 스케줄까지만 처리합니다.
...
5. 연락처: 실제 전화번호 추출 (예: 010-1234-5678), 없으면 빈 줄
6. 브랜드: 원본 그대로, 대괄호만 제거 (K [ 세븐스 ] → K 세븐스)
7. 앨범: 그대로 (30P, 기본30P 등)
8. 작가: 이름만
9. 담당자: 이름 (w웨딩 장서영, 그랜드블랑 등)
10. 구분선: 스케줄 끝에 --- 표시
